    ...
    return (
        ...
        {/**
                ...
                <div className="fw-light">
                    ...
                    <h2 style={{ color: '#e94607' }} className="fs-5 fw-semibold mt-4">Reimagining Knowledge: The Future and Relevance of Symbolic Representation in the Age of LLMs</h2>
                    ...
                    <h2 style={{ color: '#e94607' }} className="fs-5 fw-semibold mt-4">Panel Chair</h2>

                    <p><a href="https://en.wikipedia.org/wiki/Ramanathan_V._Guha" target="_blank" style={{'color': '#e94607'}}>Ramanathan V. Guha</a></p>

                    <img src={guha} alt="Ramanathan V. Guha" className="rounded-3 my-4" style={{ height: 300 }} />
                    ...
                    <h2 style={{ color: '#e94607' }} className="fs-5 fw-semibold mt-4">Panelists:</h2>

                    <p><a href="https://en.wikipedia.org/wiki/Ora_Lassila" target="_blank" style={{'color': '#e94607'}}>Ora Lassila</a></p>
                    <img src={ora} alt="Ora Lassila" className="rounded-3 my-4" style={{ height: 300 }} />
                    ...
                    <img src={natasha} alt="Natasha Noy" className="rounded-3 my-4" style={{ height: 300 }} />
                    ...
                    <img src={tara} alt="Tara Raafat" className="rounded-3 my-4" style={{ height: 300 }} />
                    ...
                    <img src={elena} alt="Elena Simperl" className="rounded-3 my-4" style={{ height: 300 }} />

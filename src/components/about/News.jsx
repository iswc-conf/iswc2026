...
const NewsSection = () => {
  const newsData = [
     { date: "July 8, 2026", text: "Accepted Doctoral Consortium Papers are now Available!", isLatest:"True"},
    { date: "March 17, 2026", text: "CFP is now available for the Industry Track "},

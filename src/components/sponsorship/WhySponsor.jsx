...
export const WhySponsor = () => {
    return (
        <BaseContainer>
            <Header>Why Sponsor the International Semantic Web Conference (ISWC)</Header>
            <SubTitle>Invest in Ontologies, Knowledge Graphs, and Smarter AI</SubTitle>

            <p>Knowledge graphs, semantics, ontologies, and context are no longer niche research topics. They are now foundational to enterprise AI, trusted decision-making, and large-scale data platforms. As organizations confront challenges around AI grounding, interoperability, and long-term flexibility, the need for <b>rigorous, open, and durable approaches to knowledge</b> has become critical.</p>

            <p>ISWC is the premier global forum where these foundations are created, debated, and advanced. Sponsoring ISWC is not a branding exercise — it is a <b>strategic investment</b> in foresight, talent, and the long-term health of the knowledge ecosystem enterprises increasingly depend on</p>

            <UnderlineHeader>1. Anticipating opportunities for innovation</UnderlineHeader>

            <p><b>Strategic foresight and research influence</b></p>
            ...
            <UnderlineHeader>2. Elite Talent Access</UnderlineHeader>

            <p><b>Hiring, credibility, and long-term capability building</b></p>

            <p>ISWC convenes one of the most concentrated gatherings of deep expertise in semantics and knowledge representation anywhere in the world — including leading researchers, applied scientists, and future technical leaders.
            </p>
            ...
            <p><b>Why it matters:</b> Sponsoring ISWC builds trust and visibility with the people shaping the future of knowledge-driven systems.</p>


            <UnderlineHeader>3. Ecosystem Stewardship</UnderlineHeader>
            ...
            <UnderlineHeader>A Call to Leadership</UnderlineHeader>
            ...
            <ul>
                    ...
                    <li>Building authentic credibility with elite technical talent

...
>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ border: "1px solid black", padding: "8px" }}>810,00 EUR</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>990,00 EUR</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>1150,00 EUR</td>
    </tr>
    <tr>
      <td style={{ border: "1px solid black", padding: "8px" }}>Academic*</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>670,00 EUR</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>830,00 EUR</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>990,00 EUR</td>
    </tr>
    <tr>
      <td style={{ border: "1px solid black", padding: "8px" }}>Student</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>500,00 EUR</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>600,00 EUR</td>
      <td style={{ border: "1px solid black", padding: "8px" }}>760,00 EUR</td>
    </tr>
  </tbody>
</table>
...
<p>All registration fees are listed in EUR and do not include tax (22% VAT)
</p>

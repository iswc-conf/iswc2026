/**
 * ISWC 2026 keynote speakers, in programme order.
 *
 * id           Anchor target, used by the speaker index at the top of the page.
 * name         Speaker's name.
 * affiliation  Role and institution, shown under the name.
 * photo        Portrait import.
 * label        Section label, e.g. "Keynote Talk".
 * abstract     Optional array of paragraphs describing the talk.
 * bio          Array of paragraphs. Kept as separate strings so long
...
export const keynotes = [
  {
    ...
    name: "James Hendler",
    affiliation:
      "Tetherless World Professor of Computer, Web and Cognitive Sciences, Rensselaer Polytechnic Institute",
    photo: jim,
    label: "ISWC 25th Anniversary Keynote Talk",
    abstract: [
    ...
    bio: [
      "James Hendler is the Tetherless World Professor of Computer, Web and Cognitive Sciences at RPI. In fifty years as an AI researcher, Hendler has worked in areas including planning, scalable KR, semantic data integration and global technology policy. He is best known for his work in bringing AI to the Web, as well as in government open data, knowledge graphs, and what's now known as neuro-symbolic AI.",
      "He is a fellow of the AAAI, AAIA, AAAS, ACM, BCS, IEEE and the US National Academy of Public Administration. Among other awards, in 2025, Hendler received the AAAI Feigenbaum Award for “a sustained record of high-impact seminal contributions to experimental AI research” and in 2026 was a co-recipient of the life-time achievement award from the Knowledge Graph Society.",
    ],
    link: {
      href: "https://en.wikipedia.org/wiki/James_Hendler",
      label: "James Hendler on Wikipedia",
    },
  },
...

  {
    ...
    bio: [
      ...
      "She is a EurAI fellow, AAAI fellow, AAIS fellow and fellow of the BCS, and was awarded in 2021 an ERC Advanced grant on “Argumentation-based Deep Interactive Explanations”. She has published over 200 papers, co-chaired ICLP 2015 (the 31st International Conference on Logic Programming), KR 2018 (the 16th Conference on Principles of Knowledge Representation and Reasoning), and COMMA 2022 (9th International Conference on Computational Models of Argument), was the conference chair for ICLP 2023 and is currently the conference chair for IJCAI-ECAI 2026. She is on the editorial board of the Argument and Computation journal and associate editor for Theory and Practice of Logic Programming. She is also on the Board of Directors for KR Inc. and an IJCAI trustee.",
    ],
  },
];
